  ...
  <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
      <header class="flex justify-between items-start mb-2">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Neutral Reviews</h2>
      ...
      <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1"></div>
      <div class="flex items-start">
        <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">1,283</div>
      </div>
    </div>
        ...
        // Indigo line
        {
          ...
          backgroundColor: function(context) {
            ...
            return chartAreaGradient(ctx, chartArea, [
              { stop: 0, color: `rgba(${hexToRGB(tailwindConfig().theme.colors.gray[500])}, 0)` },
              { stop: 1, color: `rgba(${hexToRGB(tailwindConfig().theme.colors.gray[500])}, 0.3)` }
            ]);
          },
