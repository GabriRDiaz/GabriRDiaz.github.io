  ...
  <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
      <header class="flex justify-between items-start mb-2">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Positive Reviews</h2>
        ...
        // Indigo line
        {
          ...
          backgroundColor: function(context) {
            ...
            return chartAreaGradient(ctx, chartArea, [
              ...
              { stop: 1, color: `rgba(${hexToRGB(tailwindConfig().theme.colors.green[500])}, 0.5)` }
            ]);
          },
