  ...
  <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
      <header class="flex justify-between items-start mb-2">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Negative Reviews</h2>
      ...
      <div class="flex items-start">
        <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">5,962</div>
      </div>
    </div>
        ...
        // Indigo line
        {
          ...
          backgroundColor: function(context) {
            ...
            return chartAreaGradient(ctx, chartArea, [
              ...
              { stop: 1, color: `rgba(${hexToRGB(tailwindConfig().theme.colors.red[700])}, 0.8)` }
            ]);
          },
